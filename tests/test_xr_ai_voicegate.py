...
def test_load_voice_gate_config_parses_quoted_listening_chime_false(
    tmp_path: pathlib.Path,
):
    path = tmp_path / "voice_gate.yaml"
    path.write_text('magic_phrases: agent\nlistening_chime: "false"\n')
...
def test_load_voice_gate_config_rejects_unknown_listening_chime_string(
    tmp_path: pathlib.Path,
):
    path = tmp_path / "voice_gate.yaml"
    path.write_text("listening_chime: sometimes\n")
