...
def build_mcp(
    ...
    async def get_frame_from_time(
        ...
        # Anchored chunk lookup. Body copied from the deprecated
        # get_frame_at_time, with the target timestamp computed from
        # (anchor - second_ago) rather than passed in directly.
