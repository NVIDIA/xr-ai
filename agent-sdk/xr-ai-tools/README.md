...
<a id="typed-capability-services"></a>
<a id="image-selection-and-vlm-query-tools"></a><a id="marker-tracking"></a>
<a id="magenta-polygon-image-editing"></a>

Refer to the [xr-ai-tools guide](https://nvidia.github.io/xr-ai/latest/reference/agent-sdk-tools.html).
