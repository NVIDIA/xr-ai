...
| Network telemetry | `onNetworkMetrics` | `onNetworkMetrics` + published snapshot | `onNetworkMetrics` | **parity** | All expose quality, RTT, and receive jitter from LiveKit-native stats on an approximately one-second cadence. |
