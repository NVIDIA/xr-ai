...
"""SLAM classes for object detection and mapping."""
...
from slam.utils.general_utils import to_numpy, to_tensor
...
class MapObjectList(DetectionList):
    ...
    def to_serializable(self):
        s_obj_list = []
        for obj in self:
            obj['mask'] = []    # remove the mask to save memory - this becomes a major bottleneck as we increase number of frames
