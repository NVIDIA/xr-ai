...
- **nemotron35-lightning-llm** serves the text-only
  ...
  service can be selected for either LLM role while visual inference remains
  on a separate VLM. The checkpoint uses native NVFP4 on Blackwell and W4A16 kernels on
