...
Brings up:
  ...
  * pose-mcp            (the SLAM backend wired on this branch)
...
_PROCESSES: list[Process] = [
    ...
    # SLAM backend.  Branch-specific; on feat/pose-mcp-fast this is pose-mcp.
    # CPU-only feature-based monocular SLAM (MoGe + XFeat + LighterGlue);
    # no special install — `uv sync` in agent-mcp-servers/pose-mcp/ is enough.
    Process("slam",   "../../agent-mcp-servers/pose-mcp", "pose_mcp_server",
