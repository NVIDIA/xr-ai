...
Brings up:
  ...
  * droid-mcp           (the SLAM backend wired on this branch)
...
_PROCESSES: list[Process] = [
    ...
    # SLAM backend.  Branch-specific; on feat/droid-mcp this is droid-mcp.
    # See agent-mcp-servers/droid-mcp/README.md for first-run install
    # (CUDA + droid_slam from princeton-vl/DROID-SLAM).
    Process("slam",   "../../agent-mcp-servers/droid-mcp", "droid_mcp_server",
