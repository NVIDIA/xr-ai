...
def _became(
    prim_type: str | None = None, *, r_min: float | None = None, g_min: float | None = None, b_min: float | None = None
):
...
CASES = [
    # ── direct render ops ─────────────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "r": (0.7, 1.0), "g": (0.0, 0.4), "b": (0.0, 0.4)},
            },
        ],
    },
    {
        ...
        "result": [
            {
                ...
                "args": {"obj_id": "sphere-0", "g": (0.5, 1.0), "r": (0.0, 0.3), "b": (0.0, 0.3)},
            },
        ],
    },
    {
    ...
    # ── object-anchored move (bare direction) ─────────────────────────────────
    {
        ...
        "scene": [{"id": "box-0", "type": "box", "pos": [0.0, 1.7, -1.5], "color": [0, 0.4, 1], "size": 0.1}],
        "user": "Move the cube left one meter.",
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (-1.05, -0.95), "y": (1.65, 1.75), "z": (-1.55, -1.45)},
            },
        ],
    },
    # User-anchored: object's current pos is irrelevant, lands relative to user.
    {
        ...
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [3.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1}],
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "x": (3.95, 4.05), "y": (1.55, 1.65), "z": (-1.55, -1.45)},
            },
        ],
    },
    {
        "name": "move_above_me_user_anchored",
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [1.0, 1.25, -0.15], "color": [1, 0, 0], "size": 0.1}],
        "user": "Move it above my head.",
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "x": (-0.05, 0.05), "z": (-0.05, 0.05), "y": (1.9, 3.5)},
            },
        ],
    },
    {
        "name": "rolled_head_move_left_1m",
        "scene": [{"id": "box-0", "type": "box", "pos": [0.0, 1.7, -1.5], "color": [0.2, 0.9, 0.9], "size": 0.1}],
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (-1.10, -0.85), "y": (1.65, 1.75), "z": (-1.55, -1.30)},
            },
        ],
    },
    {
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "box-0", "x": (0.95, 1.05)}},
        ],
    },
    {
        "name": "move_down_30cm",
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [0.0, 1.7, -1.5], "color": [1, 0, 0], "size": 0.1}],
        "user": "Move it down 30 centimeters.",
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (1.35, 1.45)}},
        ],
    },
    # ── object-relative placement (above, behind, etc.) ───────────────────────
    {
        "name": "above_sphere_30cm",
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [0.0, 1.5, -1.5], "color": [1, 0, 0], "size": 0.1}],
    ...
    },
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [-0.07, 1.59, -1.47], "color": [0, 0.8, 0], "size": 0.1},
            {"id": "sphere-2", "type": "sphere", "pos": [1.0, 1.6, -1.5], "color": [0, 0, 1], "size": 0.1},
        ],
    ...
    # ── scale ────────────────────────────────────────────────────────────────
    {
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "size": (0.29, 0.31)}},
        ],
    },
    {
        "name": "scale_half",
    ...
    },
    {
        ...
        "scene": [{"id": "sphere-1", "type": "sphere", "pos": [0.13, 1.80, -1.59], "color": [0, 0, 1], "size": 0.1}],
        "user": "Double its size.",
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-1", "size": (0.19, 0.21)}},
        ],
    },
    # ── multi-object: swap two object positions ───────────────────────────────
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [-0.5, 1.6, -1.5], "color": [0, 0.8, 0], "size": 0.1},
            {"id": "sphere-1", "type": "sphere", "pos": [1.0, 1.0, -2.0], "color": [0, 0.4, 1], "size": 0.1},
        ],
        "user": "Swap the cube and the blue sphere.",
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (0.95, 1.05), "y": (0.95, 1.05), "z": (-2.05, -1.95)},
            },
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-1", "x": (-0.55, -0.45), "y": (1.55, 1.65), "z": (-1.55, -1.45)},
            },
        ],
    },
    # ── compound: two distinct objects in a single utterance ──────────────────
    {
        ...
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "g": (0.5, 1.0), "r": (0.0, 0.3), "b": (0.0, 0.3), "z": (-3.0, -0.5)},
            },
            {
                "tool": "add_primitive",
                "args": {"prim_type": "box", "b": (0.5, 1.0), "r": (0.0, 0.3), "g": (0.0, 0.5), "z": (0.5, 3.0)},
            },
        ],
    },
    # ── compound: mixed add + update in one utterance ─────────────────────────
    {
        ...
        "result": [
            ...
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "r": (0.7, 1.0), "g": (0.0, 0.4), "b": (0.0, 0.4)},
            },
        ],
    },
    # ── multi-target: "all" plural pronoun ────────────────────────────────────
    {
        ...
        "scene": [
            ...
            {"id": "sphere-1", "type": "sphere", "pos": [0.5, 1.6, -1.5], "color": [0, 1, 0], "size": 0.1},
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "b": (0.7, 1.0), "r": (0.0, 0.4), "g": (0.0, 0.4)},
            },
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-1", "b": (0.7, 1.0), "r": (0.0, 0.4), "g": (0.0, 0.4)},
            },
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "b": (0.7, 1.0), "r": (0.0, 0.4), "g": (0.0, 0.4)},
            },
        ],
    },
    # ── midpoint between user and object ──────────────────────────────────────
    {
        ...
        "scene": [{"id": "box-0", "type": "box", "pos": [0.0, 1.6, -2.0], "color": [0, 0.8, 0], "size": 0.1}],
    ...
    # ── stacking ──────────────────────────────────────────────────────────────
    {
        ...
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [0.5, 1.5, -1.5], "color": [1, 0, 0], "size": 0.2}],
    ...
    # ── three-object compound ─────────────────────────────────────────────────
    {
        ...
        "scene": [],
        "user": "Put a red sphere in front of me, a blue cube to my right, and a green pyramid behind me.",
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "r": (0.7, 1.0), "g": (0.0, 0.4), "b": (0.0, 0.4), "z": (-3.0, -0.3)},
            },
            {
                "tool": "add_primitive",
                "args": {"prim_type": "box", "b": (0.5, 1.0), "r": (0.0, 0.3), "g": (0.0, 0.5), "x": (0.3, 3.0)},
            },
            {
                "tool": "add_primitive",
                "args": {"prim_type": "pyramid", "g": (0.5, 1.0), "r": (0.0, 0.4), "b": (0.0, 0.4), "z": (0.3, 3.0)},
            },
        ],
    },
    ...
    # ── diagonal: combined offsets ────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (-2.0, -0.05), "y": (1.65, 3.5), "z": (-1.55, -1.45)},
            },
        ],
    },
    # ── next to ───────────────────────────────────────────────────────────────
    {
        "name": "next_to_cube",
        "scene": [{"id": "box-0", "type": "box", "pos": [0.5, 1.6, -1.5], "color": [0, 0.4, 1], "size": 0.1}],
    ...
    # ── remove all of a kind ──────────────────────────────────────────────────
    {
        ...
        "scene": [
            ...
            {"id": "box-0", "type": "box", "pos": [0.0, 1.6, -1.5], "color": [0, 0.8, 0], "size": 0.1},
        ],
    ...
    {
        "name": "bring_closer",
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [0.0, 1.6, -3.0], "color": [1, 0, 0], "size": 0.1}],
        "user": "Bring it closer to me.",
        # Closer to user → z grows toward 0.
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "z": (-2.99, -0.99)}},
        ],
    },
    # ── colour synonym ────────────────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "g": (0.5, 1.0), "b": (0.5, 1.0), "r": (0.0, 0.4)},
            },
        ],
    },
    # ── unique reference ──────────────────────────────────────────────────────
    {
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "size": (0.11, 1.0)}},
        ],
    },
    # ── three operations in one utterance ─────────────────────────────────────
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [0.0, 1.6, -1.5], "color": [0, 0.8, 0], "size": 0.1},
            {"id": "pyramid-0", "type": "pyramid", "pos": [-1.0, 1.6, -1.5], "color": [1, 1, 0], "size": 0.1},
        ],
        ...
        "result": [
            ...
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "b": (0.7, 1.0), "r": (0.0, 0.4), "g": (0.0, 0.5)},
            },
    ...
    # ── named size: "huge" ────────────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "r": (0.7, 1.0), "g": (0.0, 0.4), "b": (0.0, 0.4), "size": (0.4, 1.5)},
            },
        ],
    },
    # ── numeric size in centimeters ──────────────────────────────────────────
    {
        ...
        "result": [
            {"tool": "add_primitive", "args": {"prim_type": "box", "r": (0.7, 1.0), "size": (0.13, 0.32)}},
        ],
    },
    # ── user not at origin ────────────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "g": (0.5, 1.0), "x": (1.95, 2.05), "z": (-0.5, 0.5)},
            },
        ],
    },
    # ── shape change ──────────────────────────────────────────────────────────
    ...
    # ── 1m above the cube ─────────────────────────────────────────────────────
    {
        ...
        "scene": [{"id": "box-0", "type": "box", "pos": [0.5, 1.0, -1.5], "color": [0, 0.4, 1], "size": 0.1}],
    ...
    # ── rolled head + diagonal user-anchored ──────────────────────────────────
    {
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (1.7, 3.5)}},
        ],
    },
    # ── proximity to another object ──────────────────────────────────────────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [-2.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
            {"id": "box-0", "type": "box", "pos": [1.0, 1.6, -1.5], "color": [0, 0.4, 1], "size": 0.1},
        ],
        "user": "Move the sphere closer to the cube.",
        # Closer to cube at x=1 means sphere.x grows from -2 toward 1.
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "x": (-1.95, 0.95)}},
        ],
    },
    # ── colour outside table ──────────────────────────────────────────────────
    {
        "name": "color_brown_not_in_table",
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [0.0, 1.6, -1.5], "color": [1, 1, 1], "size": 0.1}],
        "user": "Make it brown.",
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "r": (0.3, 0.8), "g": (0.1, 0.5), "b": (0.0, 0.4)},
            },
        ],
    },
    # ── ordinal disambiguation ────────────────────────────────────────────────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [-1.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-1", "type": "sphere", "pos": [0.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-2", "type": "sphere", "pos": [1.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
        ],
        "user": "Make the second sphere green.",
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-1", "g": (0.5, 1.0), "r": (0.0, 0.4), "b": (0.0, 0.4)},
            },
        ],
    },
    # ── vague move ────────────────────────────────────────────────────────────
    ...
    # ── place where I am ──────────────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "x": (-0.05, 0.05), "y": (1.55, 1.65), "z": (-0.55, 0.05)},
            },
        ],
    },
    # ── make spheres bigger ──────────────────────────────────────────────────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [-0.5, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-1", "type": "sphere", "pos": [0.5, 1.6, -1.5], "color": [0, 0.4, 1], "size": 0.1},
            {"id": "box-0", "type": "box", "pos": [0.0, 1.6, -1.5], "color": [0, 0.8, 0], "size": 0.1},
        ],
        "user": "Make the spheres bigger.",
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "size": (0.11, 1.0)}},
            {"tool": "update_primitive", "args": {"obj_id": "sphere-1", "size": (0.11, 1.0)}},
        ],
    ...
    # ── between with distractors ──────────────────────────────────────────────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [-1.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-1", "type": "sphere", "pos": [1.0, 1.6, -1.5], "color": [0, 0.4, 1], "size": 0.1},
            {"id": "sphere-2", "type": "sphere", "pos": [0.0, 1.6, -3.0], "color": [0, 0.8, 0], "size": 0.1},
            {"id": "box-0", "type": "box", "pos": [-2.0, 1.6, 0.0], "color": [1, 1, 0], "size": 0.1},
        ],
    ...
    # ── pitched up: above me is gravity-aligned ───────────────────────────────
    {
        ...
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [0.5, 1.0, -1.5], "color": [1, 0, 0], "size": 0.1}],
        "pose": {
            "is_valid": True,
            "position": {"x": 0.0, "y": 1.6, "z": 0.0},
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "x": (-0.05, 0.05), "z": (-0.05, 0.05)}},
        ],
    },
    # ── place at my feet ──────────────────────────────────────────────────────
    {
        ...
        "result": [
            {
                "tool": "add_primitive",
                "args": {"prim_type": "sphere", "r": (0.7, 1.0), "y": (-0.05, 0.5)},
            },  # near the floor
        ],
    },
    # ── ambiguous red sphere — pick one ───────────────────────────────────────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [0.5, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-1", "type": "sphere", "pos": [-0.5, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
        ],
    ...
    # ── stack three cubes ─────────────────────────────────────────────────────
    {
        ...
        "result": [
            {"tool": "add_primitive", "args": {"prim_type": "box", "b": (0.5, 1.0)}},
            {"tool": "add_primitive", "args": {"prim_type": "box", "b": (0.5, 1.0)}},
            {"tool": "add_primitive", "args": {"prim_type": "box", "b": (0.5, 1.0)}},
        ],
    ...
    # ── way to the left, no number ────────────────────────────────────────────
    {
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "x": (-3.0, -0.5)}},
        ],
    },
    ...
    # sphere), NOT the yellow sphere whose y was just changed.
    {
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-1", "x": (0.95, 1.05), "y": (1.55, 1.65), "z": (-1.55, -1.45)},
            },
        ],
    },
    # ── undo: "put it back" restores prior coords from [Recent moves] ────────
    {
        ...
        "scene": [{"id": "sphere-0", "type": "sphere", "pos": [1.0, 1.6, -1.5], "color": [1, 1, 0], "size": 0.1}],
        "history": [
            ("Make a yellow sphere.", "Added a yellow sphere."),
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "x": (-0.05, 0.05), "y": (1.55, 1.65), "z": (-1.55, -1.45)},
            },
        ],
    },
    ...
    {
        "name": "undo_undo_that",
        "scene": [{"id": "box-0", "type": "box", "pos": [0.0, 2.6, -1.5], "color": [0, 0.4, 1], "size": 0.1}],
        "history": [
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (-0.05, 0.05), "y": (1.55, 1.65), "z": (-1.55, -1.45)},
            },
        ],
    },
    # ── spatial disambiguation: "the X on the right" picks rightmost x ───────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [0.0, 1.6, -1.5], "color": [1, 1, 0], "size": 0.1},
            {"id": "sphere-1", "type": "sphere", "pos": [-0.48, 1.4, -0.8], "color": [1, 1, 0], "size": 0.1},
        ],
    ...
    # ── plural pronoun "them" → every recently-named object ────────────────
    {
        ...
        "scene": [
            {"id": "sphere-0", "type": "sphere", "pos": [0.0, 1.6, -1.5], "color": [1, 1, 0], "size": 0.1},
            {"id": "sphere-2", "type": "sphere", "pos": [0.0, 1.5, -1.5], "color": [0, 0, 1], "size": 0.1},
        ],
        "history": [
            ("Make a yellow sphere.", "Added a yellow sphere."),
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "x": (0.95, 1.05), "y": (1.55, 1.65), "z": (-1.55, -1.45)},
            },
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-2", "x": (0.95, 1.05), "y": (1.45, 1.55), "z": (-1.55, -1.45)},
            },
        ],
    },
    # ── batch move: every math call must be paired with update_primitive ────
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [-0.96, 1.23, -0.08], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-0", "type": "sphere", "pos": [1.00, 1.60, -1.44], "color": [1, 1, 0], "size": 0.1},
            {"id": "sphere-2", "type": "sphere", "pos": [0.14, 1.60, -0.92], "color": [0, 0, 1], "size": 0.1},
        ],
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (-1.05, -0.85), "y": (1.18, 1.28), "z": (-1.13, -1.03)},
            },
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "x": (0.95, 1.05), "y": (1.55, 1.65), "z": (-2.50, -2.40)},
            },
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-2", "x": (0.10, 0.20), "y": (1.55, 1.65), "z": (-1.97, -1.87)},
            },
        ],
    },
    # ── origin must come from SCENE block, not [Recent moves] ───────────────
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [-0.96, 1.23, -0.08], "color": [1, 0, 0], "size": 0.1},
            {"id": "sphere-0", "type": "sphere", "pos": [1.00, 1.60, -1.44], "color": [1, 1, 0], "size": 0.1},
            {"id": "sphere-2", "type": "sphere", "pos": [0.00, 1.50, -1.50], "color": [0, 0, 1], "size": 0.1},
        ],
        "recent_moves": [
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-2", "x": (-1.05, -0.95), "y": (1.45, 1.55), "z": (-1.55, -1.45)},
            },
        ],
    },
    ...
    # midpoint add.
    {
        ...
        "result": [
            ...
            {
                "tool": "update_primitive",
                "args": {"obj_id": "sphere-0", "x": (-1.0, -0.92), "y": (1.20, 1.27), "z": (-0.13, -0.03)},
            },
        ],
    },
    ...
    # every "X in Y" into a swap.
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [0.0, 1.6, -1.5], "color": [0, 0.4, 1], "size": 0.3},
            {"id": "sphere-0", "type": "sphere", "pos": [1.0, 1.6, -1.5], "color": [1, 0, 0], "size": 0.1},
        ],
    ...
    # Same scene shape as the rightmost case but the cue is "leftmost".
    {
        ...
        "scene": [
            {"id": "pyramid-0", "type": "pyramid", "pos": [-1.30, 1.50, -2.20], "color": [0.6, 0, 1], "size": 0.1},
            {"id": "pyramid-1", "type": "pyramid", "pos": [0.40, 1.50, -2.20], "color": [0.6, 0, 1], "size": 0.1},
        ],
    ...
    # the existing pyramid.
    {
        ...
        "scene": [
            {"id": "box-0", "type": "box", "pos": [0.5, 0.6, -1.5], "color": [1, 1, 0], "size": 0.1},
            {"id": "sphere-0", "type": "sphere", "pos": [0.5, 0.7, -1.5], "color": [0, 0.4, 1], "size": 0.1},
            {"id": "pyramid-0", "type": "pyramid", "pos": [0.0, 1.6, 0.5], "color": [0, 0.8, 0], "size": 0.1},
        ],
        "history": [
            ("Add a green pyramid above me and a bit behind.", "Added a green pyramid."),
            ("Switch the box and the sphere.", "Swapped the box and the sphere."),
        ],
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "pyramid-0", "x": (0.45, 0.55), "y": (0.75, 2.5), "z": (-1.55, -1.45)},
            },
        ],
    },
    ...
    # is the teeth: an add_primitive alongside the update is also a fail.
    {
        ...
        "scene": [{"id": "box-0", "type": "box", "pos": [0.0, 0.6, -1.5], "color": [0, 0.4, 1], "size": 0.1}],
        ...
        "result": [
            {
                "tool": "update_primitive",
                "args": {"obj_id": "box-0", "x": (-0.05, 0.05), "y": (1.55, 3.5), "z": (-0.05, 0.05)},
            },
        ],
        "ignore_extra": False,
    },
    ...
    # are left unspecified so partial updates pass.
    {
        ...
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (1.7, 3.0)}},
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (1.7, 3.0)}},
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (1.7, 3.0)}},
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (0.5, 1.61)}},
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (0.5, 1.61)}},
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "y": (0.5, 1.61)}},
        ],
    },
    ...
    },
    {
        ...
        "must_call_first": PERCEPTION_TOOLS,
        "result": [
            {"tool": "update_primitive", "args": {"obj_id": "sphere-0", "b": (0.5, 1.0), "r": (0.0, 0.3)}},
        ],
    },
    {
        ...
        "must_call_first": PERCEPTION_TOOLS,
        "result": [
            {"tool": "add_primitive", "args": {"prim_type": "box", "g": (0.5, 1.0), "r": (0.0, 0.4), "b": (0.0, 0.3)}},
        ],
    },
]
