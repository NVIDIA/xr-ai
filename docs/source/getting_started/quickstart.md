...
`models.hosted-nim.json` and provide an `NGC_API_KEY` as an
...
`api_key_env: NGC_API_KEY`. Refer to the credentials and AI-services guides
for full details (and self-hosted NIM containers).
