...
superseded speech. Transcript persistence is not added because this sample has
no conversation-memory behavior to preserve. `xr-ai-pipecat` remains available
for `xr-render-demo` and other unmigrated consumers.
